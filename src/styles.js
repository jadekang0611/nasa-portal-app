...
export const useSearchFormStyles = makeStyles((theme) => ({
  paper: {
    marginTop: theme.spacing(6),
    display: 'flex',
    flexDirection: 'column',
...
export const useFeedPageStyles = makeStyles(() => ({
  mainWrapper: {
    paddingTop: '20px',
  },
}));

export const useFeedPostStyles = makeStyles(() => ({
  root: {
    minWidth: 275,
    height: '100%',
  },
...
export const useFeedPostSkeletonStyles = makeStyles((theme) => ({
  container: {
    overflow: 'hidden',
    position: 'relative',
    borderRadius: '3px',
